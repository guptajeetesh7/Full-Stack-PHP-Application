...
if($connection = mysql_connect($db_host, $db_user, $db_pass)){
		...
		if(mysql_select_db($db_name)){
			...
			$query = 'CREATE TABLE `posts` ( `id` INT NOT NULL AUTO_INCREMENT , `person` VARCHAR(30) NOT NULL , `text` VARCHAR(200) NOT NULL , `image` VARCHAR(200) NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;';
